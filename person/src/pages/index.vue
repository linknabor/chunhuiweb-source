<template>
   <div class="ind"> 
        ...
        <div class="bottom-info divider" style="text-align: center; display: block;">
            <div class="divider highlight" style="text-align: center;width:100%;font-size:16px">长按关注春晖社区，尊享更多服务和商品</div>
            <img style="width: 200px;" src="../assets/images/change_chunhui.jpg">
       </div>
    ...
    methods: {
        ...
        gotoEdit() {
            if(this.common.hasRegister()) {
                ...
                // location.href="https://test.e-shequ.com/weixin/person/register.html?v=20151217"
            }
        },
        //现金券
        coupons() {
...
.inner{width:50%;float: left;height: 100%;}
