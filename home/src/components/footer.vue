...
.footer_wuye{background-image: url('../assets/images/icon_property.png');}
.footer_zenzhi_selected{background-image: url('../assets/images/icon_daojia_selected.png');}
		        ...
		        <ul>
		        	<li>
			            <a href="javascript:void(0);" class="nav-controller active">
			              <i class="footer_logo footer_zenzhi_selected"></i>社区生活
			            </a>
			        </li>
		        	<li>
			            <a :href="config.home_footer.url1" class="nav-controller">
			              	<i class="footer_logo footer_wuye"></i>社区物业
			            </a>
			        </li>
			        <li>
			            <a :href="config.home_footer.url2" class="nav-controller">
